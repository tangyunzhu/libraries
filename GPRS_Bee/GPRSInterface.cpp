...
GPRSInterface::GPRSInterface(int tx, int rx, int power, int baudRate, const char* apn, const char* userName, const char *passWord) : GPRS(tx,rx,power,baudRate,apn,userName,passWord)
{
    ip_set = false;
}
