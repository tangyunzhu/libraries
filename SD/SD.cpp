...
boolean SDClass::begin(uint8_t csPin) {
   ...
   */
	...
	flag1=card.init(SPI_HALF_SPEED, csPin);
//	if(flag1==1)
//		Serial.println("flag1=1");
	flag2=volume.init(card);
//	if(flag2==1)
//		Serial.println("flag2=1");
	flag3=root.openRoot(volume);
//	if(flag3==1)
//		Serial.println("flag3=1");
